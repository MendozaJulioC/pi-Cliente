...
const getIndicador = async(req, res)=>{
    try {
        fetch('http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/list-indicador')
        .then(res=> res.json())
        .then(data=>{
...
const getComponente = async(req, res)=>{
    try {
        fetch('http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/list-componente')
        .then(res=>res.json())
        .then(data=>{
...
const getPrograma = async(req, res)=>{
    try {
        fetch('http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/list-programas')
        .then(res=>res.json())
        .then(data=>{
            programas = data.data;
