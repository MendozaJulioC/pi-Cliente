...
const getRegister = async(req, res )=>{
   try {
    const message = req.flash('message')[0]  ;
       fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/see/api/dependencias`)
       .then(res=>res.json())
       .then(data=>{
           dep =data.data
        ...
        if(errors.length>0){
            ...
            .then(respuesta=>{
                ...
                if(validaEmail.length>0){
                    ...
                    fetch('http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/auth/api/register',{
                        method: "POST",
