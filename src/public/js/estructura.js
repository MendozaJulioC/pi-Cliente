...
async function linea(linea){
    try {
        spinner()
        let tabla=''
        fetch(`https://sse-pdm.herokuapp.com/pi/api/line/${linea}`)
        .then(res=>res.json())
        .then(datos=>{
...
async function componente(componente){
    try {
        ...
        let tabla=''
        fetch(`https://sse-pdm.herokuapp.com/pi/api/componentes/${componente}`)
        .then(res=>res.json())
        .then(datos=>{
            let tam = datos.data.length;
            document.getElementById('tabla_indicadores').innerHTML="";
...
async function prg(programa){
    try {
       // spinner()
        let tabla=''
        fetch(`https://sse-pdm.herokuapp.com/pi/api/programas/${programa}`)
        .then(res=>res.json())
        .then(datos=>{
            let tam = datos.data.length;
            document.getElementById('tabla_indicadores').innerHTML="";
