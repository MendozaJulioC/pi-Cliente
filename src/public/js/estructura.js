...
async function linea(linea){
    try {
        spinner()
        let tabla=''
        fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/line/${linea}`)
        .then(res=>res.json())
        .then(datos=>{
...
async function componente(componente){
    try {
        ...
        let tabla=''
        fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/componentes/${componente}`)
        .then(res=>res.json())
        .then(datos=>{
            let tam = datos.data.length;
            document.getElementById('tabla_indicadores').innerHTML="";
...
async function prg(programa){
    try {
       // spinner()
        let tabla=''
        fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/programas/${programa}`)
        .then(res=>res.json())
        .then(datos=>{
            let tam = datos.data.length;
            document.getElementById('tabla_indicadores').innerHTML="";
