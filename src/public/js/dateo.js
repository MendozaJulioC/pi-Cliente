...
async function graphInicial(){
  try {
    var dateo=[];
    fetch('http://api.avanzamedellin.info/pi/api/total-avance-lineas')
    .then(res=>res.json())
    .then(datos=>{
...
async function _Components(){
  try {
    ...
    fetch('http://api.avanzamedellin.info/pi/api/total-componentes')
    .then(res=> res.json())
    .then(datos=>{
...
async function contadorSemaforo(){
  try {
    fetch(`http://api.avanzamedellin.info/pi/api/semaforo-corte/contador` )
    .then(res => res.json())
    .then(response =>{
...
async function estado_sem_pordep(codsemaforo) {
  try {
    let info=[];
    fetch(`http://api.avanzamedellin.info/pi/api/semaforo-corte/general/${codsemaforo} `)
    .then(res=> res.json()).
    then(datos=>{
      let tam = datos.data.length;
