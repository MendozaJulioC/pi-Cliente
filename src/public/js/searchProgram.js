...
async function _getBuscaNombrePrograma(){
    ...
    try {
        fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/programas/consulta/nombre/${nom_Programa}`)
        .then(res=>res.json())
        .then(datos=>{
            let tabla='';
            ...
            let avanceprograma = (avancexpeso/peso_total)*100
             ...
             fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/programas/responsables/nombre/${nom_Programa}`)
            .then(res=>res.json())
            .then(response=>{
 ...
 async function _getBuscaCodigoPrograma(){
    ...
    if (cod_programa.length>=5){
        try {
          fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/programas/consulta/codigo/${cod_programa}`)
            .then(res => res.json())
            .then(datos => {
              let tabla='';
              if(datos.data.length>0){
                ...
                _graphAvancePrograma(avanceprograma)
                //responsables
                  fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/programas/responsables/codigo/${cod_programa}`)
                    .then(res=>res.json())
                    .then(response3=>{
                        let tabla3=''
 ...
 async function alerta_nomprograma(nom_Programa){
  try {
    fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/programas/semaforo-corte/alerta/${nom_Programa}`)
    .then(res=> res.json())
    .then(response=>{
        const dataSource = {
        chart: {
...
async function pptoPrograma(cod_programa){
  ...
  try {
        fetch(`http://ec2-18-118-211-122.us-east-2.compute.amazonaws.com/pi/api/programa/ppto/${cod_programa}`)
        .then(res=> res.json())
        .then(datos=>{
          const dataSource = {
            chart: {
