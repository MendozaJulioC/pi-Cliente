...
async function detalleAvance(){
  try { var fecha=0; var mes=0
        ...
        //fetch(`/pi/google`)
        fetch(`https://api.avanzamedellin.info/pi/api/generalpi`)
        .then( res=> res.json())
        .then(response=>{
...
async function detalleAvanceLinea(){
  try {
   ...
   // let AvanceOct2021=[]; let CumplimientoOct21=[];
    ...
    fetch(`https://api.avanzamedellin.info/pi/api/genralpilineas`)
    // fetch(`/pi/google/lineas`)
    .then( res=> res.json())
    .then(response=>{
      // console.log(response.data);
        fetch(`https://api.avanzamedellin.info/pi/api/corteslineas`).then(res=> res.json())
        .then(datos=>{        
...
async function triadaInicial2(datos){
  ...
  fetch(`https://api.avanzamedellin.info/pa/semaforo-corte/${mes}`)
  .then(res=>res.json())
  .then(response=>{
