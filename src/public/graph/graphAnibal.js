function totalAnibal() {
    fetch('http://localhost:4000/api/cuatrienios/anibal/total')
        ...
        .then(datos => {
            ...
            const Localizada = (parseInt(datos.data[0].total_localizada_anibal) / 1000000);
            const Ciudad = (parseInt(datos.data[0].total_inversión_ciudad_anibal) / 1000000);
            const PP = (parseInt(datos.data[0].ppanibal) / 1000000);
            
            am4core.useTheme(am4themes_animated);
            // Themes end
            var chart = am4core.create("chartdiv_total2012_2015", am4charts.PieChart);
    ...
    const geojson_url2 = "/GeoJson/map_med_anibal.geojson";
    fetch(geojson_url2)
        .then(res => res.json())
        .then(data => {
                    ...
                    let popupContent2 = `                       
                        ...
                        <tbody>
                                ...
                                <td scope="row">` + new Intl.NumberFormat('en-US', {
                                                style: 'currency',
                                                currency: 'USD'
                                            }).format(parseInt(feature.properties.localizada2012_2015)) + `</td>
                                </tr>
                                <tr>
                                ...
                                <td>` + new Intl.NumberFormat('en-US', {
                                                style: 'currency',
                                                currency: 'USD'
                                            }).format(parseInt(feature.properties.percapita2012_2015)) + `</td>
                                </tr>
                                <tr>
                                ...
                                <td>` + new Intl.NumberFormat('en-US', {
                                                style: 'currency',
                                                currency: 'USD'
                                            }).format(parseInt(feature.properties.pp2012_2015)) + `</td>
                                </tr>
                                <tr>
                                ...
                                <td>`+ new Intl.NumberFormat('en-US', {
                                    style: 'currency',
                                    currency: 'USD'
                                }).format(parseInt(feature.properties.total_anibal)) +` </td>
                                </tr>
                            </tbody>
                        </table>
                        </p>
    ...
    fetch('http://localhost:4000/api/cuatrienios/anibal')
        ...
        for(var i =0; i<(tam) ;i++   ){
            ...
            "total":(parseInt(datos.data[i].total_anibal)),
            "color": colorHEX()
              });
            }
            ...
            var chart = AmCharts.makeChart('chartdiv_comunas_2012_2015', {
                "theme": "none",
                "type": "serial",
                "startDuration": 2,
                 ...
                 "titles": [
                    {
                        "id": "Title-1",
                        "size": 15,
                        "text": "Total Inversión Pública Acumulada 2012-2015"
                    }
                ],
    ...
    fetch('http://localhost:4000/api/cuatrienios/detalle/'+comuna)
        ...
        .then(datos => {
           ...
           //console.log(datos.data[0].cod_comuna) 
            localizada1.innerHTML = formatter.format(Math.round(datos.data[0].localizada2012_2015))
            ciudad1.innerHTML = formatter.format(Math.round(datos.data[0].percapita2012_2015))
            pp1.innerHTML = formatter.format(parseInt(datos.data[0].pp2012_2015))
            total1.innerHTML= formatter.format(Math.round(datos.data[0].pp2012_2015) + Math.round(datos.data[0].percapita2012_2015) + Math.round(datos.data[0].localizada2012_2015)  )
        ...
        depComuna(2012, 2015,comuna, nomcomuna)
...
function depComuna(vigencia1, vigencia2, comuna, nomcomuna) {
    ...
    var data = []
    fetch('http://localhost:4000/api/cuatrienios/anibal/dependencias', {
            method: 'POST', // or 'PUT'
