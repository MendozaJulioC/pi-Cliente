...
async  function alerta_financiera(alerta){
  try {
    ...
    fetch(`https://api.avanzamedellin.info/pa/api/alerta/financiera/${alerta}`)
...
async  function alerta_fisica(alerta){
  try {
    let valor_alertafinanciera=[] 
    fetch(`https://api.avanzamedellin.info/pa/api/alerta/fisica/${alerta}`)
    .then(res=> res.json()).then(response=>{
...
async function alertafisicofinan(alerta){
  try {
    ...
    fetch(`https://api.avanzamedellin.info/pa/api/alerta/finanfisica/${alerta}`)
    .then(res=>res.json())
    .then(response=>{
...
async function alertaponderado(){
  try {
    let alertasponds=[];
    fetch(`https://api.avanzamedellin.info/pa/api/alerta/ponderado`)
    .then(res=>res.json())
    .then(response=>{
      for (let index = 0; index < response.data.length; index++) {
...
function buscavalstat(nomproyecto, cod, ejec){
  ...
  async function alertafisicamodal() {
    try {
      let countalertdep = [];
      fetch(`https://api.avanzamedellin.info/pa/pi/alerta/cuentadepfisica/${vlr_alerta}`).
      then(res => res.json()).then(response => {
        for (let index = 0; index < response.data.length; index++) {
          countalertdep.push({
